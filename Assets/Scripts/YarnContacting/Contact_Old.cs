...
public class Contact_Old {
    ...
    public Contact_Old(Yarn yarn, Contactable source, LevelManager levelManager, float initialAngle) {
        this.yarn = yarn;
        this.source = source;
    ...
    /* Update the render points for this Contact. #1#
    ...
    /* Update the line that this Contact has to the nextContact following it. #1#
